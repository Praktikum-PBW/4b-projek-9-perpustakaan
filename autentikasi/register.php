...
if (isset($_POST['submit'])) {
	...
	if ($password == $cpassword) {
		...
		if (!$result->num_rows > 0) {
			...
			$result = mysqli_query($conn, $sql);
			if ($result) {
				echo "<script>alert('Pengguna terdaftar!')</script>";
				$username = "";
				$email = "";
				$_POST['password'] = "";
				$_POST['cpassword'] = "";
			} else {
				echo "<script>alert('ada kesalahan mohon di cek kembali data anda!')</script>";
			}
		} else {
			echo "<script>alert('email telah digunakan mohon cek kembali!')</script>";
		}
